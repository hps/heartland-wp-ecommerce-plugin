...
class HpsReportTransactionDetails extends HpsAuthorization {
    ...
    public static function fromDict($rsp,$txnType,$returnType = 'HpsReportTransactionDetails'){
        ...
        $details->settlementAmount = (isset($reportResponse->Data->SettlementAmt) ? $reportResponse->Data->SettlementAmt : null);
        $details->AuthAmount = (isset($reportResponse->Data->AuthAmt) ? $reportResponse->Data->AuthAmt : null);
        ...
        if(isset($reportResponse->Data->AdditionalTxnFields)){
            ...
            $details->memo = (isset($additionalTxnFields->Description) ? $additionalTxnFields->InvoiceNbr : null);
